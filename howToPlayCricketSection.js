...
// accordion_header[0].addEventListener("click", () => {
//   for (let i = 0; i < participate_cricket_img.length; i++) {
//     if (participate_cricket_img[i] == participate_cricket_img[0]) {
//       participate_cricket_img[0].classList.remove("img-dont-show");
//     } else {
//       participate_cricket_img[i].classList.add("img-dont-show");
//     }
//   }
//   pointer.classList.add("img-goto-first");
//   accordion_button[0].classList.add("text-red");
//   for (let i = 0; i < accordion_button.length; i++) {
//     if (accordion_button[i] == accordion_button[0]) {
//       accordion_button[0].classList.add("text-red");
//     } else {
//       accordion_button[i].classList.remove("text-red");
//       accordion_button[i].classList.add("text-disable");
//     }
//   }
...
// accordion_header[1].addEventListener("click", () => {
//   for (let i = 0; i < participate_cricket_img.length; i++) {
//     if (participate_cricket_img[i] == participate_cricket_img[1]) {
//       participate_cricket_img[1].classList.remove("img-dont-show");
//     } else {
//       participate_cricket_img[i].classList.add("img-dont-show");
//     }
//   }
...
//   pointer.classList.add("img-goto-first");
//   accordion_button[1].classList.add("text-red");
//   for (let i = 0; i < accordion_button.length; i++) {
//     if (accordion_button[i] == accordion_button[1]) {
//       accordion_button[1].classList.add("text-red");
//     } else {
//       accordion_button[i].classList.remove("text-red");
//       accordion_button[i].classList.add("text-disable");
